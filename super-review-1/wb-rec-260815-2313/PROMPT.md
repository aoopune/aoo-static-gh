# Prompt: Convert workbooks-recorder bundle → `wb` workbook

You are converting a workbooks-recorder bundle into a `wb`-runnable markdown workbook. Produce exactly one markdown file as output. No preamble, no explanation — just the file contents.
