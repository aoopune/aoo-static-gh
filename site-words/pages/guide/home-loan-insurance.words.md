---
id: guide-home-loan-insurance
title_for_humans: "Guide — Insurance"
live_path: "pages/home-loan-insurance.html"
live_url: "/pages/home-loan-insurance.html"
body_master_today: "content/guide/home-loan-insurance.body.html"
layout_today: "templates/layouts/guide-home-loan-insurance.html"
...
- [Link — Overview](#t.overview.2)
- [Link — Documents](#t.documents.3)
- [Link — Tax benefits](#t.tax_benefits.4)
- [Link — Concessions](#t.concessions.5)
- [Link — Insurance](#t.insurance.6)
- [Link — If something goes wrong](#t.if_something_goes_wrong.7)
- [Link — Explore banks](#t.explore_banks.8)
- [Heading — Know what each is for before the cost joins the loan.](#t.know_what_each_is_for_before_the_cost_joins_the_.9)
- [Text — Contents](#t.contents.10)
- [Text — Two covers](#t.two_covers.11)
- [Text — Must you buy it?](#t.must_you_buy_it.12)
- [Text — Before you buy](#t.before_you_buy.13)
...
- [<strong> text](#t.additional_conditions.29)
- [<strong> text](#t.restrictive_practices.30)
- [<strong> text](#t.specific_insurance_company.31)
- [<strong> text](#t.link_sale_of_such_products_to_any_banking_produc.32)
- [<strong> text](#t.purely_voluntary.33)
- [<strong> text](#t.not_linked_to_availment_of_any_other_facility.34)
- [Text — What to check before you buy?](#t.what_to_check_before_you_buy.35)
...
- [text](#t.of_insurance_companies_by_banks_shall_be_subject.52)
- [text](#t.5_shall_not_follow_any.53)
- [text](#t.opt_for_products_of_a.54)
- [text](#t.or.55)
...
<a id="t.documents.3"></a>

## Link — Documents {#t.documents.3}
Documents

<a id="t.tax_benefits.4"></a>

## Link — Tax benefits {#t.tax_benefits.4}
Tax benefits

<a id="t.concessions.5"></a>

## Link — Concessions {#t.concessions.5}
Concessions

<a id="t.insurance.6"></a>

## Link — Insurance {#t.insurance.6}
Insurance

<a id="t.if_something_goes_wrong.7"></a>

## Link — If something goes wrong {#t.if_something_goes_wrong.7}
If something goes wrong

<a id="t.explore_banks.8"></a>

## Link — Explore banks {#t.explore_banks.8}
Explore banks

<a id="t.know_what_each_is_for_before_the_cost_joins_the_.9"></a>

## Heading — Know what each is for before the cost joins the loan. {#t.know_what_each_is_for_before_the_cost_joins_the_.9}
Know what each is for before the cost joins the loan.

<a id="t.contents.10"></a>

## Text — Contents {#t.contents.10}
Contents

<a id="t.two_covers.11"></a>

## Text — Two covers {#t.two_covers.11}
Two covers

<a id="t.must_you_buy_it.12"></a>

## Text — Must you buy it? {#t.must_you_buy_it.12}
Must you buy it?

<a id="t.before_you_buy.13"></a>
...
<a id="t.corporate_agency.28"></a>

## <strong> text {#t.corporate_agency.28}
Corporate agency

<a id="t.additional_conditions.29"></a>

## <strong> text {#t.additional_conditions.29}
additional conditions

<a id="t.restrictive_practices.30"></a>

## <strong> text {#t.restrictive_practices.30}
restrictive practices

<a id="t.specific_insurance_company.31"></a>

## <strong> text {#t.specific_insurance_company.31}
specific insurance company

<a id="t.link_sale_of_such_products_to_any_banking_produc.32"></a>

## <strong> text {#t.link_sale_of_such_products_to_any_banking_produc.32}
link sale of such products to any banking product

<a id="t.purely_voluntary.33"></a>

## <strong> text {#t.purely_voluntary.33}
purely voluntary

<a id="t.not_linked_to_availment_of_any_other_facility.34"></a>

## <strong> text {#t.not_linked_to_availment_of_any_other_facility.34}
not linked to availment of any other facility

<a id="t.what_to_check_before_you_buy.35"></a>
...
## text {#t.official_wording_from.50}
Official wording from

<a id="t.rbi_master_directions.51"></a>

## text {#t.rbi_master_directions.51}
RBI Master Directions

<a id="t.of_insurance_companies_by_banks_shall_be_subject.52"></a>

## text {#t.of_insurance_companies_by_banks_shall_be_subject.52}
of insurance companies … by banks shall be subject to the following

<a id="t.5_shall_not_follow_any.53"></a>

## text {#t.5_shall_not_follow_any.53}
(5) … shall not follow any

<a id="t.opt_for_products_of_a.54"></a>

## text {#t.opt_for_products_of_a.54}
… opt for products of a
