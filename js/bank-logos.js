...
var ShroffinBankLogos = (() => {
  ...
  // src/bank-logos.js
  var require_bank_logos = __commonJS({
    "src/bank-logos.js"(exports, module) {
      var BANK_LOGO_FILES = {
      ...
      var DEFAULT_BANK_LOGO_BASE = "../images/banks/";
      ...
      function bankLogoHtml(bankName, basePath) {
        ...
        if (!src) return "";
        return '<img class="hlc-bank-logo" src="' + escapeAttr(src) + '" alt="" width="26" height="26" decoding="async" loading="lazy">';
      }
